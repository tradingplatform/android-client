...
public class OneWeekFragment extends Fragment implements CompoundButton.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (this.orientation == Configuration.ORIENTATION_PORTRAIT) {
            root = inflater.inflate(R.layout.fragment_one_week, container, false);
        } else {
            root = inflater.inflate(R.layout.fragment_one_week, container, false);
        }
...
//        title.setTypeface(serifLight);
    ...
    private void prepareChart() {
        ...
        horizontalAxis.setDateTimeFormat(new SimpleDateFormat("E dd"));
