...
public class SixMonthFragment extends Fragment implements CompoundButton.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (this.orientation == Configuration.ORIENTATION_PORTRAIT) {
            root = inflater.inflate(R.layout.fragment_six_month, container, false);
        } else {
            root = inflater.inflate(R.layout.fragment_six_month, container, false);
        }
...
//                    i++;
        ...
        horizontalAxis.setMajorTickInterval(40);
